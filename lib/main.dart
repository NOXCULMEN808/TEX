...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: AuthScaffold(
        title: 'ساخت حساب',
        subtitle: 'برای شروع در TEX ثبت‌نام کنید',
        child: Column(
          children: [
            TextField(
...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    ...
    passwordController = TextEditingController(
      text: widget.registeredPassword ?? '',
    );
  }
  ...
  void login() {
    if (emailController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('ایمیل و رمز عبور را وارد کنید.'),
        ),
      );
      return;
    }
    ...
    if (widget.registeredEmail != null &&
        (emailController.text.trim() != widget.registeredEmail ||
            passwordController.text != widget.registeredPassword)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('ایمیل یا رمز عبور صحیح نیست.'),
        ),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: AuthScaffold(
        title: 'ورود',
        subtitle: 'به حساب TEX وارد شوید',
        child: Column(
          children: [
            TextField(
              controller: emailController,
